...
export const changeDifficulty = ()        => {window.location.href = '/levelConfig.html'}
export const reauth           = ()        => {window.location.href = '/auth.html'}
...
export const getUser          = (username = localStorage.getItem('currentUser')) => 
                                            {return JSON.parse(localStorage.getItem(username))}
export const getPoints        = (username = localStorage.getItem('currentUser')) => 
                                            {return getUser(username)._points}
export const getRecord        = (username = localStorage.getItem('currentUser')) =>
...
const generateStats = (form, board, box, points, point, attempts, randomItem) => 
{
...
export const generateButton = (name, width = '200px', height='50px') => {
